...
class HRDAHead(BaseDecodeHead):
    ...
    # def hr_crop_slice(self, scale):
    #     """根据 crop_box 类型返回正确数量的 slice"""
    #     if isinstance(self.hr_crop_box, list):
    #         crop_y11, crop_y12, crop_x11, crop_x12 = scale_box(self.hr_crop_box[0], scale)
    #         crop_y21, crop_y22, crop_x21, crop_x22 = scale_box(self.hr_crop_box[1], scale)
    #         return (slice(crop_y11, crop_y12), slice(crop_x11, crop_x12),
    ...
    def forward(self, inputs, return_fused=False):
        ...
        if has_crop:  # ###
            ...
            # else:
            #     hr_seg_inserted[:, :, slc[0], slc[1]] = hr_seg  #todo
        ...
        if return_fused:  # ###
            ...
            # else:
            #     fhr[:, :, slc[0], slc[1]] = fused_feats_hr #todo
